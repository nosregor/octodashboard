...
const GlobalStyle = createGlobalStyle`
  ...
  @font-face {
    font-family: 'Hind';
    src: url('../static/assets/fonts/Hind/hind-v10-latin-500.woff2') format('woff2'),
    url('../static/assets/fonts/Hind/hind-v10-latin-500.woff') format('woff');
    font-weight: 500;
    font-style: normal;
  }
  @font-face {
    font-family: 'Hind';
    src: url('../static/assets/fonts/Hind/hind-v10-latin-600.woff2') format('woff2'),
    url('../static/assets/fonts/Hind/hind-v10-latin-600.woff') format('woff');
    font-weight: 600;
    font-style: normal;
  }
  @font-face {
